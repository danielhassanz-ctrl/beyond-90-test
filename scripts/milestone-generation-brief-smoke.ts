...
for (const headline of ["Recibes el Balón de Oro", "Te coronas con el The Best", "Eres elegido Balón de Oro", "Te conceden la Bota de Oro", "Te otorgan el The Best"]) assert.equal(milestoneVisualSpec(share(headline)).kind, "trophy", headline);
for (const headline of ["Premian a tu compañero con el Balón de Oro", "Entregan el Golden Boy a un rival", "Dan el The Best al capitán", "La prensa entrega la Bota de Oro a otro jugador", "Dan el Balón de Oro a tu abuelo", "Entregan el Golden Boy a tu abuela", "Premian a tu tío con el The Best", "Dan la Bota de Oro a tu tía", "Entregan el Balón de Oro a tu primo", "Premian a tu prima con el Golden Boy", "Dan el Balón de Oro a tu pareja"]) assert.equal(milestoneVisualSpec(share(headline)).kind, "career", headline);
