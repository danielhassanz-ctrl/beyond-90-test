...
export const PEOPLE_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    text: (s) => { const c=ensureCareerCast(s); return `${c.coach.name} te hace pasar al despacho. No habla de sueños: habla de lo que ve. “Tienes talento, pero ahora mismo estás detrás de gente más hecha. Quiero saber si vas a tener paciencia cuando no juegues”.`; },
    choices: [
