...
export function milestoneVisualSpec(share: ShareData): MilestoneVisualSpec {
  ...
  const thirdPartyRetirement = /\b(?:rival|oponente|adversario|adversaria|companero|companera|otro jugador|otra jugadora|capitan|capitana|entrenador|seleccionador|padre|madre|hermano|hermana|hijo|hija|pareja|novio|novia|amigo|amiga)\b/.test(haystack);
